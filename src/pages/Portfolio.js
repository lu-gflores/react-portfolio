...
import SatoshiSite from '../images/satoshi-site.gif'
    ...
    <>
      <section className="hero is-dark is-large" data-aos="flip-left">
        <div className="hero-body">
          ...
          <h2 className="title is-4 has-text-centered">Check out my projects!</h2>
        </div>
      </section>

      <section className="hero is-medium is-success">
        <div className="hero-body">
          <h1 className="title is-1 has-text-centered" data-aos="zoom-in" data-aos-offset="250">Renowned Works of Satoshi Kon</h1>
          <figure className="image" >
            <img className="project-image" src={SatoshiSite} style={{ width: "750px", height: "400px" }}
              alt="Satoshi Kon Site"
              data-aos="zoom-in"
              data-aos-offset="250"
            />
          </figure>
          <div className="content has-text-centered">
            <article className="project-info">
              <p className="subtitle is-5" data-aos="zoom-in">A single page built using HTML, CSS, and some jQuery. Content of this site are based on the renowned late Japanese film director Satoshi Kon, including
                his bio, films, awards, etc. Some technolgies used include Animate.css, Normalize.css, and Waypoints.</p>
            </article>
            <a className="button is-medium" href="https://github.com/lu-gflores/satoshi-kon-site" target="_blank" rel="noopener noreferrer" data-aos="zoom-in" data-aos-offset="50">
              <span className="icon">
                <i className="fa fa-code"></i>
              </span>
              <span>Code</span>
            </a>
            <a className="button is-medium" href="https://lu-gflores.github.io/satoshi-kon-site/" target="_blank" rel="noopener noreferrer" data-aos="zoom-in" data-aos-offset="50">
              <span className="icon">
