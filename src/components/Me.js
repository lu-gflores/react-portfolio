                ...
                <div className="columns is-multiline">
                    <div className="column is-three-quarters">
                        <p className="subtitle is-4 intro has-text-center" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                            I'm a full stack web developer and a Computer Science graduate of UNC Charlotte based around Charlotte, NC. While I have a diverse background
                    ...
                    <div className="column is-half">
                        <p className="subtitle is-4 intro" data-aos="fade-left" data-aos-offset="200">
                            While I have experience in the fundamentals of web development, I also have worked in different concepts in Full Stack, including MongoDB, NodeJS, Express,
                            Handlebars, and jQuery. I'm always eager to learn more technology along the way too!
                        </p>
                    </div>
                </div>
